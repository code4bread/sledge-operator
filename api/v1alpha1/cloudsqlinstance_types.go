...
// CloudSQLInstanceSpec defines the desired state
...
// CloudSQLInstanceStatus defines the observed state
type CloudSQLInstanceStatus struct {
	Phase    string `json:"phase,omitempty"`   // e.g. Ready, Error
	Message  string `json:"message,omitempty"` // last update
